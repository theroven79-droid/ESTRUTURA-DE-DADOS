...
void consulta(int estoque[], char produto[][20], float valor[], int codigo[]);
...
void Ccodigo(int codigo[], float valor[], int estoque[], int indice);
void Cprodutos(char produto[][20], int codigo[], float valor[],
               int estoque[], int *volta);
...
int main()
{
    ...
    // Vetores principais do programa
    // O mesmo indice representa o mesmo produto em todos os vetores
    char produto[3][20] = {0};
    int codigo[3] = {0};
    float valor[3] = {0.0f};
    int estoque[3] = {0};

    // Identificador usado para encerrar o programa
    int identificador = 0;
